...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception{
		http
		.authorizeRequests()
		.antMatchers("/patient/add","/patient/get","/patient/get/{pid}","/patient/delete/{id}","/executive/add","/executive/get","/doctor/add/{depid}","/doctor/all","/doctor/getone/{id}","/receptionist/add","/receptionist/all","/receptionist/getone/{id}","/department/add","/department/get","/department/get/{did}").permitAll()
