...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception{
		http
		.authorizeRequests()
		.antMatchers("/admission/add/{rid}/{patientId}/{did}","/admission/all","/admission/getone/{id}","/admission/update/{id}","/patient/add","/patient/get","/patient/get/{pid}","/patient/delete/{id}","/room/add","/room/all","/room/getone/{id}","/executive/add","/executive/get","/doctor/add/{depid}","/doctor/all","/doctor/getone/{id}","/doctor/update/{id}","/receptionist/add","/receptionist/all","/receptionist/getone/{id}","/receptionist/update/{id}","/department/add","/department/get","/department/get/{did}","/billing/add/{admissionId}/{pid}/{did}","/billing/all","/billing/getone/{id}","/billing/update/{id}").permitAll()
